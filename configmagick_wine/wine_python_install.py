...
def install_wine_python(wine_prefix: Union[str, pathlib.Path] = configmagick_linux.get_path_home_dir_current_user() / '.wine',
    ...
    lib_shell.run_shell_command(command, shell=True, run_as_user=username, pass_stdout_stderr_to_sys=True, quiet=quiet, communicate=False)
...
def download_python_file(python_version: str, wine_prefix: Union[str, pathlib.Path],
